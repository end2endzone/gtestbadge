...
namespace bin2cpp
{
  class SvgTemplateFile : public virtual bin2cpp::File
  {
  public:
    SvgTemplateFile() :
      hProcess(NULL),
    ...
    ~SvgTemplateFile() { unloadResource(); }
    virtual size_t getSize() const { return mBufferSize; }
    virtual const char * getFilename() const { return "template.svg"; }
    ...
    void loadResource()
    {
      ...
      if (hProcess)
      {
        ...
        if ( EnumProcessModules( hProcess, &hModule, sizeof(hModule), &cbNeeded) )
        {
          ...
          hResourceInfoBlock = FindResource(hModule, "html5skeletonAGE632H2D7", "CUSTOM");
  ...
  const File & getSvgTemplateFile() { static SvgTemplateFile _instance; return _instance; }
}; //bin2cpp
